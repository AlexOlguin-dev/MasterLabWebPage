...
const Download = () => {
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      ...
      <Box sx={{ position: "relative", width: "100%", height: "1500px", backgroundImage: `url(${BGTop})`, backgroundSize: "cover", backgroundPosition: "center", display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
